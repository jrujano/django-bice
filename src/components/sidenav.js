...
class Sidenav extends Component {
  ...
  render() {
    return (
      <aside className="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-square">
        ...
        <ul className="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
          ...
          <li className="navigation-header"><a className="navigation-header-text" href="/#!">Applications</a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          {/* <li className="navigation-header"><a className="navigation-header-text" href="/#!">Pages </a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          <li className="navigation-header"><a className="navigation-header-text" href="/#!">User Interface </a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          {/* <li className="navigation-header"><a className="navigation-header-text" href="/#!">Tables &amp; Forms </a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          <li className="navigation-header"><a className="navigation-header-text" href="/#!">Charts</a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          <li className="navigation-header"><a className="navigation-header-text" href="/#!">Misc </a><i className="navigation-header-icon material-icons">more_horiz</i>
          </li>
          ...
          <li className="bold">
            <a className="waves-effect waves-cyan " href="https://pixinvent.com/materialize-material-design-admin-template/documentation/index.html" 
          ...
          <li className="bold"><a className="waves-effect waves-cyan " href="https://pixinvent.ticksy.com/" target="_blank"   without="true" rel="noopener noreferrer">
